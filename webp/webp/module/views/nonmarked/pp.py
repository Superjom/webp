...
def index(request):
    ...
    return render_to_response("html/nonmarked/pp/index.html", dic)
...
def list(request):
    ...
    return render_to_response("html/nonmarked/pp/list.html", dic)
...
def show(request):
    ...
    return render_to_response("html/nonmarked/pp/show.html", dic)
...
def createinit(request):
    ...
    return render_to_response("html/nonmarked/pp/create.html", dic)
...
def create_schedule(request):
    ...
    try:
        ...
        return render_to_response("html/nonmarked/pp/createschedule.html", dic)
