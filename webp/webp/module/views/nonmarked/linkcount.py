...
def index(request):
    ...
    return render_to_response("html/nonmarked/linkcount/index.html", dic)
...
def list(request):
    ...
    return render_to_response("html/nonmarked/linkcount/list.html", dic)
...
def show(request):
    ...
    return render_to_response("html/nonmarked/linkcount/show.html", dic)
...
def createinit(request):
    ...
    return render_to_response("html/nonmarked/linkcount/create.html", dic)
...
def create_schedule(request):
    ...
    try:
        ...
        return render_to_response("html/nonmarked/linkcount/createschedule.html", dic)
