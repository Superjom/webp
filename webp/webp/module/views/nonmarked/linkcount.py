...
def index(request):
    ...
    func = module.get_func('linkcount')
    func = module.get_func('linkcount')
    dic.update({
    ...
    return render_to_response("html/nonmarked/linkcount/linkcount_index.html", dic)
    return render_to_response("html/nonmarked/linkcount/linkcount_index.html", dic)
...
def list(request):
    ...
    return render_to_response("html/nonmarked/linkcount/linkcount_list.html", dic)
    return render_to_response("html/nonmarked/linkcount/linkcount_list.html", dic)
...
def show(request):
    ...
    return render_to_response("html/nonmarked/linkcount/linkcount_show.html", dic)
    return render_to_response("html/nonmarked/linkcount/linkcount_show.html", dic)
...
def createinit(request):
    ...
    return render_to_response("html/nonmarked/linkcount/linkcount_create.html", dic)
    return render_to_response("html/nonmarked/linkcount/linkcount_create.html", dic)
...
def create_schedule(request):
    ...
    try:
        ...
        return render_to_response("/html/nonmarked/linkcount/linkcount_createschedule.html", dic)
        return render_to_response("/html/nonmarked/linkcount/linkcount_createschedule.html", dic)
