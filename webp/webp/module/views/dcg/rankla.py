...
def list(request):
    ...
    return render_to_response("html/dcg/rankla/list.html", dic)
...
def createinit(request):
    ...
    return render_to_response("html/dcg/rankla/create.html", dic)
...
def create_schedule(request):
    ...
    try:
        ...
        return render_to_response("html/dcg/rankla/createschedule.html", dic)
