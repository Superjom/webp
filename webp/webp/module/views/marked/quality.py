...
def index(request):
    ...
    module = user.get_module('marked')
    func = module.get_func('quality')
    dic.update({
    ...
    return render_to_response("html/marked/quality/index.html", dic)
...
def list(request):
    ...
    return render_to_response("html/marked/quality/list.html", dic)
...
def show(request):
    ...
    return render_to_response("html/marked/quality/show.html", dic)
...
def createinit(request):
    ...
    return render_to_response("html/marked/quality/create.html", dic)
...
def create_schedule(request):
    ...
    try:
        ...
        return render_to_response("html/marked/quality/createschedule.html", dic)
