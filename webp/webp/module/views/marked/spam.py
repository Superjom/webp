...
def index(request):
    ...
    return render_to_response("html/marked/spam/index.html", dic)
...
def list(request):
    ...
    return render_to_response("html/marked/spam/list.html", dic)
...
def show(request):
    ...
    return render_to_response("html/marked/spam/show.html", dic)
...
def createinit(request):
    ...
    return render_to_response("html/marked/spam/create.html", dic)
...
def create_schedule(request):
    ...
    try:
        ...
        return render_to_response("html/marked/spam/createschedule.html", dic)
