...
def index(request):
    ...
    func = module.get_func('markedtac')
    ...
    dic.update(data)
    return render_to_response("html/marked/tac/tac_index.html", dic)


def list(request):
    tac_name = request.GET.get('tagname', '')
    module_id = ModuleCtrl.get_id(flag='marked')
    res = TacCtrl.search(
            tac_id=-1,
            module_id=module_id, 
            tac_name=tac_name)
    ...
    return render_to_response("html/marked/tac/tac_list.html", dic)
...
def createinit(request):
    ...
    return render_to_response("html/marked/tac/tac_create.html", dic)
...
def updateinit(request):
    ...
    return render_to_response("html/marked/tac/tac_update.html", dic)
