...
Tac.prototype = {
    list : function(){
        ...
        htmlobj=$.ajax({url:baseUrl+"/"+encodeURI($("#tac_name").val()+"list"),async:false});
    ...
    createinit : function(){
        ...
        htmlobj=$.ajax({url:baseUrl+"/"+encodeURI($("#tac_name").val()+"createinit"),async:false});
